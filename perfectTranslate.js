...
const enPath = path.join(__dirname, 'client/src/i18n/services_en.json');
const hiPath = path.join(__dirname, 'client/src/i18n/services_hi.json');
const guPath = path.join(__dirname, 'client/src/i18n/services_gu.json');
...
const serviceRegistryPath = path.join(__dirname, 'client/src/data/servicesRegistry.js');
