...
async function run() {
    ...
    fs.writeFileSync(path.join(__dirname, 'client/src/i18n/services_hi.json'), JSON.stringify(hiFinal, null, 2));
    ...
    fs.writeFileSync(path.join(__dirname, 'client/src/i18n/services_gu.json'), JSON.stringify(guFinal, null, 2));
